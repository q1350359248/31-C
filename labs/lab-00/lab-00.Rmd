...
```{r setup-tibble}
usernames <- c("wilsonamy", "q1350359248", "Hu-Wanqing", "username 3", "username 4") #Extend if necessary
nums <- c(18, 2, 5, NA, NA) #Extend if necessary
colours <- c("powderblue", "blue", "white", "colour 2", "colour 4") #Extend if necessary
hobbies <- c("Hiking", "swimming", "study", "Hobby 3", "Hobby 4") #Extend if necessary
